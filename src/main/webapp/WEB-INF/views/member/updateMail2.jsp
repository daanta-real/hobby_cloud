            ...
            <div id="cont1">
                ...
                <div class="row p-sm-2 mx-1 mb-5">
                 <div class="panel-body container">
					...
					<input type="text" id="idMail" name="emailId" class="input form-control" required> @
                    <input type="text" id="inputMail" name="emailDomain" class="input form-control" required readonly>
                    </div>
                        <select id="emailBox" name="emailBox" class="input form-control mt-2" required>
                        ...
                        <input type="button" id="emailCheck" class="adCheck col-auto btn btn-sm btn-outline-primary mt-2" value="인증하기">
                        <input type="hidden" name="email" >
                   	<div id="mailComm"></div>
					
					<input type="text" id="reKey" class="input form-control" maxlength="20" placeholder="인증번호를 입력해주세요" required>
                   	<input type="button" id="reKeyCheck" class="adCheck col-auto btn btn-sm btn-outline-primary mt-2" value="확인">
                  <br>
                  <br>
                </div>
            </div> 
