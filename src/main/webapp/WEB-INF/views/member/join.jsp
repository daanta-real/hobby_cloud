...
<ARTICLE class="d-flex flex-column align-items-start col-lg-8 mx-md-1 mt-xs-2 mt-md-3 pt-2">
	...
	<SECTION class="w-100 pt-0 fs-6">
			...
			<div class="container">
				<form name="searchForm" method="post" class="row" enctype="multipart/form-data" id="join_form">
					...
					<div class="form-group col-12">
						...
						<input name="memberPw"  id="searchForm_memberNick" type="password" class="form-control" placeholder="특수문자, 영문, 숫자, 6자 이상 20자 이내로 입력하세요" value="}">
						<!-- <small id="searchForm_memberIdx_tip" class="form-text text-muted">회원 번호를 입력하십시오.</small>-->
					</div>
					<div class="form-group col-12">
						<label for="searchForm_memberNick" class="form-label mb-0">비밀번호확인</label>
						<input name="memberPw2" id="searchForm_memberNick" type="password" class="form-control" placeholder="비밀번호를 한번 더 입력하세요" value="">
						<!-- <small id="searchForm_memberIdx_tip" class="form-text text-muted">회원 번호를 입력하십시오.</small>-->
					</div>
					<div class="form-group col-12">
						<label for="searchForm_memberNick" class="form-label mb-0">닉네임</label>
						<input name="memberNick" id="searchForm_memberNick" type="text" class="form-control" placeholder="닉네임을 입력하세요" value="">
						<!-- <small id="searchForm_memberIdx_tip" class="form-text text-muted">회원 번호를 입력하십시오.</small>-->
					</div>
      ...
      <div class="form-group col-12">
		...
		<div class="region_name"></div>
		 	...
		 	<button type="button" class="btn btn-outline-primary mt-1">주소 찾기</button>
    ...
    <div class="form-check">
    <legend class="mt-4">관심분야</legend>
        <input class="form-check-input" type="checkbox"  name="lecCategoryName" value="운동" id="flexCheckDefault">
        <label class="form-check-label" for="flexCheckDefault">
          운동
        </label>
        </div>
        <div class="form-check">
        <input class="form-check-input" type="checkbox" name="lecCategoryName" value="음악" id="flexCheckDefault">
        <label class="form-check-label" for="flexCheckDefault">
          음악
        </label>
        </div>
        <div class="form-check">
        <input class="form-check-input" type="checkbox" name="lecCategoryName" value="미술" id="flexCheckDefault">
        <label class="form-check-label" for="flexCheckDefault">
          미술
        </label>
        </div>
